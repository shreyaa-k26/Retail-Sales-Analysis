...
This project simulates a real-world retail business environment by generating synthetic retail datasets, storing them in a relational MySQL database, performing SQL-based analysis, and creating professional business visualizations and an **Executive Sales Performance Dashboard**.
